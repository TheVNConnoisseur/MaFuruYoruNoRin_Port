(() => {
    var e = {
            ...
            445: (e, t, r) => {
                ...
                var s = o(r(575)),
                    n = o(r(913)),
                    a = o(r(539)),
                    i = "1.9.0-20240423190513-22f6924",
                    u = {
                    ...
                    c = function() {
                        function OGVLoaderBase() {
                            (0, s.default)(this, OGVLoaderBase), this.base = this.defaultBase()
                        }
                        return (0, n.default)(OGVLoaderBase, [{
                            key: "defaultBase",
                            ...
                            value: function urlForScript(e) {
                                if (e) {
                                    var t = this.base;
                                    return void 0 === t ? t = "" : t += "/", t + e + "?version=" + encodeURIComponent(i)
                                }
                                ...
                                var s = this.getGlobal(),
                                    ...
                                    a = function classWrapper(t) {
                                        return (t = t || {}).locateFile = function(e) {
                                            return "data:" === e.slice(0, 5) ? e : o.urlForScript(e)
                                        }, t.mainScriptUrlOrBlob = o.scriptForClass(e) + "?version=" + encodeURIComponent(i), s[e](t)
                                    };
                                "function" == typeof s[e] ? t(a) : this.loadScript(n, (function() {
                                    t(a)
                                }))
                            }
                        }]), OGVLoaderBase
            ...
            713: (e, t, r) => {
                ...
                var c = new(function(e) {
                    ...
                    function OGVLoaderWorker() {
                        return (0, s.default)(this, OGVLoaderWorker), t.apply(this, arguments)
                    }
                    return (0, n.default)(OGVLoaderWorker, [{
                        key: "loadScript",
            ...
            172: (e, t, r) => {
                ...
                var u = function() {
                    function OGVWorkerSupport(e, t) {
                        var r = this;
                        (0, n.default)(this, OGVWorkerSupport), this.propList = e, this.handlers = t, this.transferables = function() {
                        ...
                        }(), this.target = null, this.sentProps = {}, this.pendingEvents = [], this.handlers.construct = function(e, t) {
                            var o = e[0],
                                s = e[1];
                            i.default.loadClass(o, (function(e) {
                                e(s).then((function(e) {
                                    for (r.target = e, t(); r.pendingEvents.length;) r.handleEvent(r.pendingEvents.shift())
                                }))
                            }))
                    ...
                    return (0, a.default)(OGVWorkerSupport, [{
                        key: "handleEvent",
                        value: function handleEvent(e) {
                            ...
                            this.handlers[e.action].call(this, e.args, (function(r) {
                                ...
                                t.propList.forEach((function(e) {
                                    var r = t.target[e];
                                    if (t.sentProps[e] !== r)
                                        if (t.sentProps[e] = r, "duration" == e && isNaN(r) && isNaN(t.sentProps[e]));
                                        else if ("audioBuffer" == e) {
                                        if (o[e] = r, r)
                                            for (var n = 0; n < r.length; n++) s.push(r[n].buffer)
                                    } else "frameBuffer" == e ? (o[e] = r, r && (s.push(r.y.bytes.buffer), s.push(r.u.bytes.buffer), s.push(r.v.bytes.buffer))) : o[e] = r
                                }));
                                var n = {
                                    action: "callback",
                        ...
                        value: function workerOnMessage(e) {
                            var t = e.data;
                            t && "object" === (0, s.default)(t) && ("transferTest" == t.action || ("string" != typeof t.action || "string" != typeof t.callbackId || "object" !== (0, s.default)(t.args) ? console.log("invalid message data", t) : t.action in this.handlers ? "construct" == t.action || this.target ? this.handleEvent(t) : this.pendingEvents.push(t) : console.log("invalid message action", t.action)))
                        }
                    }]), OGVWorkerSupport
                }();
                t.default = u
            ...
            443: (e, t, r) => {
                ...
                var s = new(o(r(172)).default)(["loadedMetadata", "videoFormat", "frameBuffer", "cpuTime"], {
                    ...
                    processFrame: function processFrame(e, t) {
                        this.target.processFrame(e[0], (function(e) {
                            t([e])
                        }))
                    },
                    ...
                    recycleFrame: function recycleFrame(e, t) {
                        this.target.recycleFrame(e[0]), t()
                    }
                });
                t.default = s
            },
            539: (e, t, r) => {
                ...
                var i = new(function() {
                    function WebAssemblyChecker() {
                        (0, n.default)(this, WebAssemblyChecker), this.tested = !1, this.testResult = void 0
                    }
                    return (0, a.default)(WebAssemblyChecker, [{
                        key: "wasmSupported",
                        value: function wasmSupported() {
                            if (!this.tested) {
                                try {
                                    "object" === ("undefined" == typeof WebAssembly ? "undefined" : (0, s.default)(WebAssembly)) ? this.testResult = function testSafariWebAssemblyBug() {
    ...
    __webpack_require__.g = function() {
        ...
        "use strict";
        __webpack_require__(318)(__webpack_require__(443))
    })()
})();