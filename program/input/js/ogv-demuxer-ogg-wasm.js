var OGVDemuxerOggW = (() => {
    ...
    return (
        function(moduleArg = {}) {
            ...
            var a = moduleArg,
                g, h, readyPromise = new Promise((b, c) => {
                    g = b;
                    h = c
                }),
                l = Object.assign({}, a),
            ...
            if (p) {
                var fs = require("fs"),
                    v = require("path");
                q = n ? v.dirname(q) + "/" : __dirname + "/";
                r = (b, c) => {
                    b = w(b) ? new URL(b) : v.normalize(b);
            ...
            } else if (m || n) n ? q = self.location.href : "undefined" != typeof document && document.currentScript && (q = document.currentScript.src), _scriptDir && (q = _scriptDir),
                q.startsWith("blob:") ? q = "" : q = q.substr(0, q.replace(/[?#].*/, "").lastIndexOf("/") + 1), r = b => {
            ...
            var H = 0,
                I = null,
                J = null,
                K = b => b.startsWith("data:application/octet-stream;base64,"),
                w = b => b.startsWith("file://"),
                L;
            L = "ogv-demuxer-ogg-wasm.wasm";
            if (!K(L)) {
                var M = L;
                L = a.locateFile ? a.locateFile(M, q) : q + M
            }

            function N(b) {
                if (b == L && y) return new Uint8Array(y);
                if (u) return u(b);
            ...
            function O(b) {
                if (!y && (m || n)) {
                    if ("function" == typeof fetch && !w(b)) return fetch(b, {
                        credentials: "same-origin"
                    }).then(c => {
                        if (!c.ok) throw `failed to load wasm binary file at '${b}'`;
                        return c.arrayBuffer()
                    }).catch(() => N(b));
                    if (t) return new Promise((c, d) => {
                        t(b, e => c(new Uint8Array(e)), d)
                    })
                }
                return Promise.resolve().then(() => N(b))
            }

            function P(b, c, d) {
                return O(b).then(e => WebAssembly.instantiate(e, c)).then(d, e => {
            ...
            function Q(b, c) {
                var d = L;
                return y || "function" != typeof WebAssembly.instantiateStreaming || K(d) || w(d) || p || "function" != typeof fetch ? P(d, b, c) : fetch(d, {
                    credentials: "same-origin"
                }).then(e => WebAssembly.instantiateStreaming(e, b).then(c, function(f) {
            ...
            var R = b => {
                ...
                S = {
                    ...
                    d: b => {
                        ...
                        for (var d = 1; 4 >= d; d *= 2) {
                            ...
                            e = Math.max(b, e);
                            a: {
                                f = (f.min.call(f, 2147483648, e + (65536 - e % 65536) % 65536) - z.buffer.byteLength + 65535) / 65536;
                                try {
                                    z.grow(f);
                                    C();
                                    var k = 1;
                    ...
                    a: function(b, c, d, e) {
                        var f = z.buffer;
                        a.audioPackets.push({
                            data: f.slice ? f.slice(b, b + c) : (new Uint8Array(new Uint8Array(f,
                                b, c))).buffer,
                            timestamp: d,
                            discardPadding: e
                        })
                    ...
                    c: function(b, c) {
                        function d(e) {
                            for (var f = "", k = new Uint8Array(z.buffer); 0 != k[e]; e++) f += String.fromCharCode(k[e]);
                            return f
                        }
                        b && (a.videoCodec = d(b));
                        c && (a.audioCodec = d(c));
                    ...
                    b: function(b, c, d, e, f) {
                        var k = z.buffer;
                        a.videoPackets.push({
                            data: k.slice ? k.slice(b, b + c) : (new Uint8Array(new Uint8Array(k, b, c))).buffer,
                            timestamp: d,
                            keyframeTimestamp: e,
                            isKeyframe: !!f
                        })
                ...
                T = function() {
                    ...
                    if (a.instantiateWasm) try {
                        ...
                        x(`Module.instantiateWasm callback failed with error: ${d}`), h(d)
                    }
                    Q(c, function(d) {
                        b(d.instance)
                    }).catch(h);
            ...
            a._ogv_demuxer_init = () => (a._ogv_demuxer_init = T.i)();
            a._ogv_demuxer_receive_input = (b, c) => (a._ogv_demuxer_receive_input = T.j)(b, c);
            a._ogv_demuxer_process = () => (a._ogv_demuxer_process = T.k)();
            a._ogv_demuxer_destroy = () => (a._ogv_demuxer_destroy = T.l)();
            a._ogv_demuxer_media_length = () => (a._ogv_demuxer_media_length = T.m)();
            a._ogv_demuxer_media_duration = () => (a._ogv_demuxer_media_duration = T.n)();
            a._ogv_demuxer_seekable = () => (a._ogv_demuxer_seekable = T.o)();
            a._ogv_demuxer_keypoint_offset = b => (a._ogv_demuxer_keypoint_offset = T.p)(b);
            a._ogv_demuxer_seek_to_keypoint = b => (a._ogv_demuxer_seek_to_keypoint = T.q)(b);
            a._ogv_demuxer_flush = () => (a._ogv_demuxer_flush = T.r)();
            a._malloc = b => (a._malloc = T.t)(b);
            a._free = b => (a._free = T.u)(b);
            var U;
            J = function aa() {
                U || V();
                U || (J = aa)
            ...
            function V() {
                ...
                if (!(0 < H)) {
                    if (a.preRun)
                        for ("function" == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length;) G();
                    R(D);
                    0 < H || (a.setStatus ? (a.setStatus("Running..."), setTimeout(function() {
                        setTimeout(function() {
                            a.setStatus("")
                        }, 1);
                        b()
